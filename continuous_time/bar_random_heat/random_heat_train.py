...
hidden_layers_size = [input_size, 20, 20, 20, 20, 20, 20, 20]
...
# Initial Model
print(f"Initial MSE - Train MSE: {check_train_MSE(train_loader,u)} - Test MSE: No closed-form solution")
if save_models:
    torch.save({
...
for epoch in range(num_epochs):
    ...
    print(f"Epoch: {epoch + 1} - Train MSE: {check_train_MSE(train_loader, u)} - Test MSE: No closed-form solution")
